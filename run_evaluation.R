...
pdf(paste0(wd, "AUC_sup.pdf"), width=8)
boxplot(eval_competiors$auc, pch=20, col=c(colors[5], colors[3]), ylab="AUC", 
        cex.lab=1.5, cex.axis=1.5, names=c("Li at al", "Our method"))
dev.off()

# Supplementary Fig S2b
pdf(paste0(wd, "Recall_sup.pdf"), width=8)
boxplot(eval_competiors$recall, pch=20, col=c(colors[5], colors[3]), 
