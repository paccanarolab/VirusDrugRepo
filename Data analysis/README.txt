This folder contains the files:
    biological_interpretation.R - R code with auxiliary functions for running the biological interpretation analysis
...
and the sub-folders:
    ...
    Embedding - drugs, virus, protein and gene signatures learned by our method
    Input - input matrices of our model (A, B, G)
